...
import com.xvshu.zk.manager.model.Tree;
import com.xvshu.zk.manager.model.TreeRoot;
...
public class ZkController {
	...
	public @ResponseBody String saveData(
		...
		Boolean  blmodify = (Boolean)session.getAttribute("userM");
		if(blmodify==null||blmodify==false){
			return "保存失败！您没有权限修改zk数据，请联系管理员！";
		}
